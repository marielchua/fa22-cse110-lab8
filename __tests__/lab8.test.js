describe('Basic user flow for Website', () => {
  ...
  it('Make sure <product-item> elements are populated', async () => {
    ...
    //Added loop to checkk all the product items in the prodItems array
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    const rootButton = await prodShadowRoot.$('button');
    await rootButton.click();
    const buttonText = await rootButton.getProperty('innerText');
    const innerText = await buttonText.jsonValue();
